...
%--------------------------------------------------------------------------
    ...
    while Global.NotTermination(Population)
        MatingPool1 = TournamentSelection(2,floor(Global.N/2),-CalHV_NormR(Population.objs,RefPoint,Global.N,nSample));
        MatingPool2 = zeros(1,floor(Global.N/2)); 
        for i=1:floor(Global.N/2)
            P1 = Population(MatingPool1(i));
            candidates_ind = TournamentSelection(2,10,-CalHV_NormR(Population.objs,RefPoint,Global.N,nSample));
