...
% r_large --- 100 --- reference point 2
    ...
    while Global.NotTermination(Population)
        for i = 1 : Global.N
            ...
            %similarity-based mating scheme 
            Parent1P1_ind = randperm(N1,1);
            Parent1P1 = Population1(Parent1P1_ind);
            candidatesP1_ind = randperm(N1, 10);
            candidates1 = Population1(candidatesP1_ind);
            dis1 = pdist2(Parent1P1.objs, candidates1.objs);
            [~, ind1] = min(dis1);  
            Parent2P1 = Population1(candidatesP1_ind(ind1));
            ParentP1 = [Parent1P1 Parent2P1];
            Offspring1 = GAhalf(ParentP1);
            
            Parent1P2_ind = randperm(N,1);
            Parent1P2 = Population(Parent1P2_ind);
            candidatesP2_ind = randperm(N, 10);
            candidates2 = Population(candidatesP2_ind);
            dis2 = pdist2(Parent1P2.objs, candidates2.objs);
            [~, ind2] = min(dis2);  
            Parent2P2 = Population(candidatesP2_ind(ind2));
            ParentP2 = [Parent1P2 Parent2P2];
            Offspring2 = GAhalf(ParentP2);
