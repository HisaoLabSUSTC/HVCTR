function HVCTR_Ablation(Global)
% <algorithm> <H>
...
% r_large --- 100 --- reference point 2
    ...
    while Global.NotTermination(Population)
        for i = 1 : Global.N
            ...
            Offspring2 = GAhalf(Population(randperm(end,2)));
            ...
            [Population1] = EnvSel_Ablation(Population1,Offspring,r_large,Zmin,Zmax);
            [Population2] = EnvSel_Ablation(Population2,Offspring,r_small,Zmin,Zmax);
