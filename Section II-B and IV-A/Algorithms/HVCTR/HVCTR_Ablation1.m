function HVCTR_Ablation1(Global)
% <algorithm> <H>
...
% r_large --- 100 --- reference point 2
    ...
    while Global.NotTermination(Population)
        for i = 1 : Global.N
            ...
            [Population1] = EnvSel(Population1,Offspring,Population2,r_small,Zmin,Zmax); %Population1 is updated using r_small
            [Population2] = EnvSel(Population2,Offspring,Population1,r_large,Zmin,Zmax); %Population2 is updated using r_large
