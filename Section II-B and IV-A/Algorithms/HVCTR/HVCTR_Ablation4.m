function HVCTR_Ablation4(Global)
% <algorithm> <H>
...
% r_large --- 100 --- reference point 2
    ...
    while Global.NotTermination(Population)
        for i = 1 : Global.N
            ...
            % Generate offspring1 from parets selected in whole population, and offspring2 from
            % parents selected in subpopulation2
            Offspring1 = GAhalf(Population(randperm(end,2))); 
