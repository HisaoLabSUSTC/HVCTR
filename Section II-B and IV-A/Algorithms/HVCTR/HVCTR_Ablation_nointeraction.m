function HVCTR_Ablation_nointeraction(Global)
% <algorithm> <H>
...
% r_large --- 100 --- reference point 2
    ...
    while Global.NotTermination(Population)
        for i = 1 : Global.N
            ...
            [Population1] = EnvSel_Ablation_nointeraction(Population1,Offspring1,r_large);
            [Population2] = EnvSel_Ablation_nointeraction(Population2,Offspring2,r_small);
...
function [Population] = EnvSel_Ablation_nointeraction(Population,Offspring,r)
